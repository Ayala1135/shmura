    ...
    <div className="card mr-8 ml-8 mt-8  shadow-8  surface-card  p-7 border-round-sm h-400rem w-80rem flex justify-content-center">
      <div className="formgrid grid grid">
        ...
        <div className="flex-auto field col col-4">
          ...
          <InputText onChange={(e) => onChange("userEmail", e.target.value)} className="text-base text-color surface-overlay p-2 border-1 border-solid surface-border border-round appearance-none outline-none focus:border-primary w-full" />
        </div>
        ...
        <div className="flex-auto field col col-4">
          ...
          <InputText onChange={(e) => onChange("userPassword", e.target.value)} className="text-base text-color surface-overlay p-2 border-1 border-solid surface-border border-round appearance-none outline-none focus:border-primary w-full" />
        </div>
        ...
        <div className="flex-auto field col col-4" >
          ...
          <InputText onChange={(e) => onChange("userFirstName", e.target.value)} className="text-base text-color surface-overlay p-2 border-1 border-solid surface-border border-round appearance-none outline-none focus:border-primary w-full" />
        </div>
        ...
        <div className="flex-auto field col col-4">
          ...
          <InputText onChange={(e) => onChange("userPhone", e.target.value)} className="text-base text-color surface-overlay p-2 border-1 border-solid surface-border border-round appearance-none outline-none focus:border-primary w-full" />
        </div>
        ...
        <div className="flex-auto field col col-2">
          ...
          <InputText list="city" autocomplete="off" type="text" id="city_name" onChange={(e) => onChange("userCity", e.target.value)} className="text-base text-color surface-overlay p-2 border-1 border-solid surface-border border-round appearance-none outline-none focus:border-primary w-full"></InputText>
          <datalist id="city">
            <option value="אחר">
        ...
        <div className="flex-auto field col col-3">
          ...
          <InputText list="school" autocomplete="off" type="text" id="inp_schoolName" onChange={(e) => onChange("userStudyPlace", e.target.value)} className="text-base text-color surface-overlay p-2 border-1 border-solid surface-border border-round appearance-none outline-none focus:border-primary w-full"></InputText>
          <datalist id="school">
        ...
        <div className="flex-auto field col col-3">
          ...
          <InputText list="business" autocomplete="off" type="text" id="inp_business" onChange={(e) => onChange("userBusiness", e.target.value)} className="text-base text-color surface-overlay p-2 border-1 border-solid surface-border border-round appearance-none outline-none focus:border-primary w-full"></InputText>
