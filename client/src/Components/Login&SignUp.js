...
export default function Login_SignUp(props) {
  ...
  const handleSubmit = async () => {
    var res = await fetchDataWithParams(
    ...
    else navigate("/ShmuraManagement");
  };
  ...
  return (
    <>
      <Toolbar></Toolbar>
      <div
        className="card  mt-8  shadow-8  surface-card border-round-sm h-400rem w-30rem flex align-items-center justify-content-center m-auto"
        style={{ padding: "6px" }}
      >
        <div className="formgrid grid grid align-items-center">
          <div className="w-full flex flex-column justify-content-center gap-2 py-5">
            <div className="flex flex-wrap justify-content-center align-items-center gap-2 ">
              ...
              <InputText
                id="username"
                type="text"
                placeholder="חשבון המייל איתו נרשמת"
          ...
          <div className="justify-content-center m-auto">
            <Divider
              layout="horizontal"
              align="center"
              className="w-25rem justify-content-center "
            >
          ...
          <div className="w-full flex align-items-center justify-content-center m-1 ">
            <Button
              ...
              className="w-10rem mx-auto bg-cyan-700 border-cyan-700"
            ></Button>
          </div>
        </div>
      </div>
